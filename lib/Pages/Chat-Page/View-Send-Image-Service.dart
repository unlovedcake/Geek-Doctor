...
class ViewSendImageService extends StatefulWidget {
  final String imageUrl;
  final String messageId;
  const ViewSendImageService({required this.imageUrl, required this.messageId});

  @override
  _ViewSendImageServiceState createState() => _ViewSendImageServiceState();
}

class _ViewSendImageServiceState extends State<ViewSendImageService> {
